...
/// <remarks>
/// This converter differs from the <see cref="CommunityToolkit.Maui.Converters.EnumToBoolConverter"/> because this
	...
	where T : struct, Enum
{
	...
	private static T GetParameterValue(object? parameter) => parameter switch
	{
		...
		_ => throw new UmbrellaMauiException("The parameter cannot be converted to the specified enum type.")
	};
}