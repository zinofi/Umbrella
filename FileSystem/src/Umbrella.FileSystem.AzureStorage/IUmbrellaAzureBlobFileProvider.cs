...
namespace Umbrella.FileSystem.AzureStorage
{
    ...
    /// the <see cref="IUmbrellaFileProvider"/> and this <see cref="IUmbrellaAzureBlobFileProvider"/> interface.
    /// This would then allow multiple storage providers to be used in parallel in the same project.
    /// </summary>
    public interface IUmbrellaAzureBlobFileProvider : IUmbrellaFileProvider
    {
    }
}