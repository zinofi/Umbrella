...
{
    //TODO: Investigate using Roslyn instead of reflection to generate the TypeScript code. Means the T4 generator can be run without having to compile beforehand
    //which would speed up development allowing T4 to run automatically
    public class AureliaClassGenerator : BaseClassGenerator
    {
        ...
        {
            base.WriteStart(modelType, builder);
        }
