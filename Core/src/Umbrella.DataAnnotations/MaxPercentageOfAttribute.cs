...
namespace JRS.Web.CMS.Models.Api.PensionBuddyCalculator
{
	/// <summary>
	...
	public class MaxPercentageOfAttribute : IsAttribute
	{
		/// <summary>
		...
		public MaxPercentageOfAttribute(string dependentProperty, double maxPercentage)
			: base(Operator.MaxPercentageOf, dependentProperty)
		{
