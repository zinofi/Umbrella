...
{
	/// <summary>
	/// Represents an exception thrown from a class in the <see cref="Umbrella.AppFramework"/> library.
	/// </summary>
	/// <seealso cref="UmbrellaException" />
	public class UmbrellaAppFrameworkException : UmbrellaException
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="UmbrellaAppFrameworkException"/> class.
		/// </summary>
