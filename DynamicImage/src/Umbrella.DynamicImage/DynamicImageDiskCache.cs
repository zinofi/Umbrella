...
namespace Umbrella.DynamicImage
{
    public class DynamicImageDiskCache : DynamicImageCache, IDynamicImageCache
    {
        ...
        #region Constructors
        public DynamicImageDiskCache(IUmbrellaHostingEnvironment hostingEnvironment,
        ...
        public void Add(DynamicImageItem dynamicImage, Func<MemoryCacheEntryOptions> options = null)
        {
            try
            {
        ...
        public DynamicImageItem Get(string key, string originalFilePhysicalPath, string fileExtension)
        {
            try
            {
                ...
                DynamicImageItem image = new DynamicImageItem();
