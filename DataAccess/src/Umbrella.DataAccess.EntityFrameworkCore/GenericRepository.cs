...
namespace Umbrella.DataAccess.EntityFrameworkCore
{
        ...
        where TEntityBase : IEntity<TEntityKey>
    {
        ...
        protected virtual void ValidatePropertyStringLength(string value, Expression<Func<TEntity, string>> propertyAccessor, int minLength, int maxLength, bool required = true)
        {
        ...
        protected virtual void ValidatePropertyNumberRange<TProperty>(TProperty? value, Expression<Func<TEntity, TProperty?>> propertyAccessor, TProperty min, TProperty max, bool required = true)
